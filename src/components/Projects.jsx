...
const projects = [
  ...
  },
  {
    ...
    subtitle: 'Financial News Classification for Market Insights',
    description:
      'Developed a Python-based NLP system to classify financial news sentiment using Word2Vec, Sentence Transformers, Random Forest, and Neural Networks for stock market insights. Combines classical ML with modern transformer embeddings.',
    icon: TrendingUp,
    iconColor: '#10b981',
    gradient: 'linear-gradient(135deg, rgba(16,185,129,0.12), rgba(34,211,238,0.08))',
    image: '/Stock market.png',
    tags: ['Python', 'NLP', 'Word2Vec', 'Sentence Transformers', 'Random Forest', 'Neural Networks'],
    categories: ['ai-ml'],
    features: [
      'Financial news analysis',
      'Sentiment classification (Positive/Negative/Neutral)',
      'Word2Vec & Sentence Transformer embeddings',
      'Random Forest & Neural Network classifiers',
    ],
    github: 'https://github.com/RajaGanapathi-M/Sentiment_Analysis_For_StockMarket_News_NLP',
    demo: '#',
    status: 'Project',
    statusColor: '#10b981',
  },
